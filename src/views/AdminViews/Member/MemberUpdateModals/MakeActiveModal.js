...
const MakeActiveModal = (props) => {
    ...
    const OnSubmitYes = async (e) => {
        ...
        await axios.post(process.env.REACT_APP_API + "MemberMakeActive", {
    ...
    return (
        <CRow>
            <CCol>
                ...
                <CButton className="btn btn-sm white width100" style={{ backgroundColor: "green" }}
                ...
                >
                    ...
                    <CModalBody >
                        <h4 className="text-center mb-5">Are You Sure Want to Active this - {props.name}?</h4>
...
export default MakeActiveModal;