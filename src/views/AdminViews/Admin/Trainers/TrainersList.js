...
const TrainersList = (props) => {
    ...
    const Parentvaluetomodal = (data, index) => {
        ...
        var temp_user = [...TrainerList];
        temp_user.splice(index, 1);
        setTrainerList([]);
        setTrainerList(temp_user);
        // console.log("temp_user: " + temp_user);
        // console.log("all user: " + TrainerList);
        // console.log("Delete")
    }
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TRAINER_LIST) ?
                                    ...
                                    <CCardBody>
                                        ...
                                        <CRow>
                                            ...
                                            <th>Adress</th> */}
                                                                ...
                                                                <th>Branch</th>
                                                                {
                                                                    cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TRAINER_EDIT) ?
                                                                        <th>Edit</th>
                                                                        : null
                                                                }

                                                                {
                                                                    cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TRAINER_DELETE) ?
                                                                        <th>Delete</th>
                                                                        : null
                                                                }

                                                                {
                                                                    cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TRAINER_DETAILS) ?
                                                                        <th>Details</th>
                                                                        : null
                                                                }
                                                            </tr>
                                                ...
                                                <td>{List.user_address}</td> */}
...

                                                                    {
                                                                        cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TRAINER_DETAILS) ?
                                                                            <td>
                                                                                <Link to={`/trainer-details?trainerid=${List.user_user_id}`}
