...
const AddNewTrainers = (props) => {
    ...
    const GetDropDown = async () => {
        await axios.post(process.env.REACT_APP_API + "GetDropDown", {
            dropdown_list: [
                ...
                { "dropdown_type": "DD_ROLES", "dropdown_filter": "" },
            ]
            ...
            if (response.data.drop_down_list != null) {
                for (let d = 0; d < response.data.drop_down_list.length; d++) {
                    ...
                    if (dd_list.each_drop_down_list != null && dd_list.dropdown_type === "DD_ROLES") {
                        let ddlist = [];
                        for (let sd = 0; sd < dd_list.each_drop_down_list.length; sd++) {
                            ddlist.push({ "value": dd_list.each_drop_down_list[sd].dd_id, "label": dd_list.each_drop_down_list[sd].dd_name })
                        }
                        setRoleDropdowns(ddlist);
                    }
                }
            }
        }).catch(error => {
    ...
    const onChangeRoledropdown = (e) => {
        console.warn(e.value);//here i will get the specific selected value
        console.warn(e.label);

        setUserAddInput({ ...UserAddInput, ["user_role_id"]: e.value });
    };
    ...
    const SubmitDocument = async (e) => {
        ...
        return post(url, formData, config).then(response => {
            ...
            if (response.data.is_success) {
                ...
                setUserAddInput({ ...UserAddInput, ["user_document"]: response.data.file_name });
    ...
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_ADD_NEW_TRAINER) ?
                    <div style={{ paddingRight: "30px", paddingLeft: "30px", paddingTop: "30px" }}>
                        <CRow>
                            <CCol xs="12" sm="12" md="12" lg="12">
                                <CCard style={{ borderRadius: "20px" }}>
                                    <CCardBody>
                                        {props.location.pfid != null ? <h4>Update Trainer</h4>
                                            :
                                        ...
                                        <CForm onSubmit={(e) => OnSubmitUser(e)}>
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3">
                                                    <CFormGroup>
                                                        ...
                                                        <CSelect name='user_gender' onChange={(e) => OnInputChange(e)} custom>
                                                            ...
                                                            <option selected={user_gender === "Others"} value="Others">Others</option>
                                                        </CSelect>
                                                    </CFormGroup>
                                                </CCol>
                                            ...
                                            <CFormGroup>
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3">
                                                    <CFormGroup>
                                                        <CLabel>Select Role</CLabel><span className="red">*</span>
                                                        <Select value={RoleDropdowns.filter(function (option) {
                                                            return option.value === user_role_id;
                                                        })}
                                                            options={RoleDropdowns}
                                                            onChange={(e) => onChangeRoledropdown(e, "user_role_id")}>
                                                        </Select>
                                                    </CFormGroup>
                                                </CCol>
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3">
                                                    <CFormGroup>
                                                        ...
                                                        <CInput type="file" name='user_document'
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3" className="mt-3">
                                                    <div className="bgcolor1 mt-3" style={{ borderRadius: "5px" }}>
                                                        <CButton type="submit" onClick={(e) => SubmitDocument(e)} disabled={disablebutton3} style={{ width: "100%", color: "white", fontWeight: "", fontSize: "" }} >Upload Document</CButton>
