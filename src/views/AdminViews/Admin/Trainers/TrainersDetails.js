...
const UserDetails = () => {
    ...
    var userid = searchParams.get("trainerid");
                        ...
                        <CCard style={{borderRadius:"20px"}}>
                            <CCardBody>
                                ...
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='' style={{ backgroundColor: "#1385c5", textAlign: "center", color: "white", fontSize: "17px" }}>TRAINER DETAILS</th>
                                        </tr>
