...
const AddNewBranch = (props) => {
    ...
    const OnSubmitBranch = async (e) => {
        ...
        if (branch_id === "") {
            await axios.post(process.env.REACT_APP_API + "BranchAdd", {
                ...
                "branch_created": cookies.user_id
    ...
    const LoadBranchDetails = async () => {
        ...
        if (props.location.pfid != null) {
            list["branch_id"] = props.location.pfid.pfid;
            await axios.post(process.env.REACT_APP_API + "BranchDetailsByID", list, config).then(response => {
                ...
                if (response.data.is_success) {
                    ...
                    setBranchAddInput(response.data.branch_details);
                }
            }).catch(
                error => {
                    console.log(error);
            ...
            <div style={{ paddingRight: "30px", paddingLeft: "30px", paddingTop: "30px" }}>
                <CRow>
                    <CCol xs="12" sm="12" md="12" lg="12">
                        <CCard>
                            <CCardBody>
                                {props.location.pfid != null ? <h4>Update Branch</h4>
                                    :
                            ...
                            <CRow>
                                <CCol className="pt-3" >
                                    <CLabel>Sub Logo</CLabel><span className="red">*</span>
                                </CCol>
                                <CCol className="pt-3">
                                    <CInput placeholder="Nadcap Logo"
                                        type="checkbox"
                                    // name="branch_nadcap_logo"
                                    // checked={branch_nadcap_logo === true}
