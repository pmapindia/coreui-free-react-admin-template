...
const DeleteModal = (props) => {
  ...
  // const modaldata=props.contact_person_name;
  const OnSubmitNo = () => {
    // props.changeDependency(modaldata2);
    setWarnings({ ["warning"]: "" });

    //props.changeDependency('donnot delete');

    //   props.changeword(chktaxes);
    setPrimary(!primary);
      ...
      <CCol>
        ...
        >
          ...
          <CModalHeader style={{ backgroundColor: "#3b3f4b", borderColor: "#3b3f4b" }}>
            ...
            <CModalTitle className="bgcolor white mt-2"><h3>Alert</h3></CModalTitle>
