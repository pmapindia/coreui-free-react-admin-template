...
const UserList = () => {
    ...
    const { user_type } = UserInput;

    const OnInputChange = (e) => {
        console.log(e.target.value);
        setUserInput({ ...UserInput, [e.target.name]: e.target.value });
        setUserLists([]);//PASSING EMPTY ARRAY
    }
    ...
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_USER_LIST) ?
                                        ...
                                        <CForm>
                                            <CRow>
                                                <CCol xs="12" sm="3" md="3" lg="3">
                                                    <CLabel>Select Type</CLabel><span className="red">*</span>
                                                    <CSelect style={{ borderRadius: "20px" }} custom name="user_type" onChange={(e) => OnInputChange(e)}>
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3" className="mt-3 pt-1">
                                                    <div class="inner-addon right-addon mt-2">
                                                ...
                                                <CCol xs="12" sm="3" md="3" lg="3" className="mt-3 pt-1">
                                                    <Link to={`/adduser`}
                                                        className="btn bgcolor white width100 mt-2" style={{ paddingLeft: "4px", textAlign: "center", backgroundColor: "#3b3f4b" }}>
                                                        Add New User
                                                    </Link>
                                                </CCol>
                                                <CCol xs="12" sm="12" md="12" lg="12">
                                            ...
                                            <th>Adress</th> */}
                                                                    ...
                                                                    <th>Branch</th>
                                                                    {
                                                                        cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_USER_EDIT) ?
                                                                            <th>Edit</th>
                                                                            : null
                                                                    }

                                                                    {
                                                                        cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_USER_DELETE) ?
                                                                            <th>Delete</th>
                                                                            : null
                                                                    }

                                                                    {
                                                                        cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_USER_DETAILS) ?
                                                                            <th>Details</th>
                                                                            : null
                                                                    }
