                        ...
                        <CCard>
                            <CCardBody>
                                ...
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='bgcolor' style={{ backgroundColor: "", textAlign: "center", color: "white", fontSize: "17px" }}>USER DETAILS</th>
                                        </tr>
                                        ...
                                        <tr style={{ textAlign: "center", color: "black" }}>
                                            ...
                                            <td colSpan={2}>{UserDetails.user_address}</td>
