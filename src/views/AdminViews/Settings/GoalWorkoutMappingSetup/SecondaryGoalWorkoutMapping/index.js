...
const SecondaryGoalWorkoutMapping = (props) => {
    ...
    const onChangeSecdropdown = (e) => {
        ...
        setSetupMapping({ ...SetupMapping, ["goal_wc_map_primary_goal_id"]: 0, ["goal_wc_map_secondary_goal_id"]: e.value });
    }
    ...
    const LoadWorkoutMapLists = async () => {
        ...
        await axios.post(process.env.REACT_APP_API + "GoalWorkoutMappingSetupListForSecondaryGoal", list, config).then(response => {
            console.log(response);
            if (response.data.is_success) {
                if (response.data.secondary_goal_workout_mapping_list !== null) {
                    setWorkoutMapList(response.data.secondary_goal_workout_mapping_list)
                }
                else {
                    setWorkoutMapList([])
                }
                ...
                <CRow>
                    <CCol xs="12" sm="12" ms="12" lg="12">
                        <CCard style={{ borderRadius: "20px" }}>
                            <CCardBody>
                                <h5>Secondary Goal Workout Mapping</h5>
                                    ...
                                    <CCol xs="12" sm="3" md="3" lg="3">
                                        <CFormGroup>
                                            ...
                                            <Select value={SecondaryDropdowns.filter(function (option) {
                                                return option.value === goal_wc_map_secondary_goal_id;
                                            })}
                                                options={SecondaryDropdowns}
                                                onChange={(e) => onChangeSecdropdown(e, "goal_wc_map_secondary_goal_id")} >
                                            </Select>
                                        </CFormGroup>
                                    </CCol>
                                    <CCol xs="12" sm="3" md="3" lg="3">
                            ...
                            <CCardBody>
                                <CRow className='overflow-hidden'>
                                    <CCol xs="12" sm="9" md="9" lg="9">
                                        <h5>Secondary Goal Workout Mapping List</h5>
                                    </CCol>
...
export default SecondaryGoalWorkoutMapping;