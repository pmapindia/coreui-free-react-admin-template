            ...
            if (response.data.is_success) {
                if (response.data.tax_group_details !== null) {
                    ...
                    if (response.data.tax_group_details.tax_group_created_at !== null) {
                        ...
                        CreatedAt=date.substring(0,10).substring(0, 10).split('-').reverse().join('-');
                    }
                    else{
        ...
        <>
            <div style={{ paddingRight: "30px", paddingLeft: "30px", paddingTop: "30px" }}>
                ...
                <table className="table table-bordered">
                    <tbody>
                        <tr>
                            <th colSpan={4} className='' style={{ backgroundColor: "#1385c5", textAlign: "center", color: "white", fontSize: "17px" }}>TAX GROUP DETAILS</th>
                        </tr>
                ...
                <table className="table table-bordered mt-3">
                    <tbody>
                        <tr>
                            <th colSpan={4} className='' style={{ backgroundColor: "#1385c5", textAlign: "center", color: "white", fontSize: "17px" }}>TAX LIST</th>
                        </tr>
                        <tr className='' style={{backgroundColor: "#38acec", fontWeight: "bold", textAlign: "center", color: "white" }}>
                            <td>SL No</td>
                            <td>TAX NAME</td>
                        ...
                        {TaxList.map((List, index) => (
                            <tr style={{ textAlign: "center", color: "black" }} key={index}>
                                ...
                                <td>{List.tax_group_tax_created_at.substring(0, 10).substring(0, 10).split('-').reverse().join('-')}</td>
                            </tr>
                        ))}
