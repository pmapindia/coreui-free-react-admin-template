...
const TermsAndConditions = (props) => {
    ...
    const { terms_and_conditions_id, terms_and_conditions } = TermsAndConditionsAdd;
    ...
    const OnSubmitTermsAndConditions = async (e) => {
        ...
        if (terms_and_conditions_id === "") {
            ...
            await axios.post(process.env.REACT_APP_API + "TermsAndConditionsUpdate", {
    ...
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_TERMS_CONDITION) ?
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                <DeleteModal delete_guid={List.terms_and_conditions_id}
                                                                    ...
                                                                    index={index}
                                                                    apiname={"TermsAndConditionsDelete"}
