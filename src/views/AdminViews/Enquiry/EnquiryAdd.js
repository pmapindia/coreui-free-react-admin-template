...
const AddNewEnquity = (props) => {
    ...
    return (
        ...
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_ADD_NEW_ENQUIRY) ?
                                            ...
                                            <CRow>
                                                ...
                                                <CCol xs="12" sm="4" md="4" lg="4">
                                                    <CFormGroup>
                                                        ...
                                                        <CInput type='text' placeholder='Enter Alternative Mobile Number'
                                                ...
                                                <CCol xs="12" sm="4" md="4" lg="4">
                                                    <CFormGroup>
                                                        ...
                                                        <CInput type='text' placeholder='Enter Email Address'
                                                ...
                                                <CCol xs="12" sm="4" md="4" lg="4">
                                                    <CFormGroup>
                                                        ...
                                                        <CInput type='date' placeholder='Joining Date'
