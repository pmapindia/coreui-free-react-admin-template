                            ...
                            <CFormGroup>
                                ...
                                <CSelect name='product_type' onChange={(e) => OnInputChange(e)} custom>
                                    ...
                                    <option selected={product_type === "PROGRAM"} value="PROGRAM">PROGRAM</option>
                                        ...
                                        <CCol xs="12" sm="3" ms="3" lg="3">
                                            <CFormGroup>
                                                <CLabel>Select Category</CLabel><span className="red">*</span> <CLabel style={{ marginLeft: "50px" }}><CategoryModal /></CLabel>
                                        ...
                                        <CCol xs="12" sm="3" ms="3" lg="3">
                                            <CFormGroup>
                                                <CLabel>Product Tag Title</CLabel><span className="red">*</span>
                                                <CInput type='text' placeholder='Enter Product Tag Title' required="required"
