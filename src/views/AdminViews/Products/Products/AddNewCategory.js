...
const AddNewCategory = (props) => {
    ...
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_ADD_NEW_CATEGORY) ?
                                            ...
                                            <table className="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Category Name</th>
                                                        {
                                                            cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_CATEGORY_EDIT) ?
                                                                <th>Edit</th>
                                                                : null
                                                        }
                                                        {
                                                            cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_CATEGORY_DELETE) ?
                                                                <th>Delete</th>
                                                                : null
                                                        }
