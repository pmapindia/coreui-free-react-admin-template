                        ...
                        <CCard>
                            <CCardBody>
                                ...
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='bgcolor' style={{ backgroundColor: "", textAlign: "center", color: "white", fontSize: "17px" }}>PRODUCT DETAILS</th>
                                        </tr>
                                        <tr className='bgcolor1' style={{ fontWeight: "bold", textAlign: "center", color: "white", fontSize: "12px" }}>
                                            <td>PRODUCT NAME</td>
                                            <td>PRODUCT TYPE</td>
                                        ...
                                        <tr style={{ textAlign: "center", color: "black" }}>
                                            ...
                                            <td><img className="playerProfilePic_home_tile "
                                                src={process.env.REACT_APP_PHOTOPATH + cookies.unique_code + "/PACKAGE/" + ProductDetails.product_cover_image}
                                ...
                                <table className="table table-bordered mt-3">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='bgcolor' style={{ backgroundColor: "", textAlign: "center", color: "white", fontSize: "15px" }}>PRODUCT FEATURE LIST</th>
                                        </tr>
                                        <tr className='bgcolor1' style={{ fontWeight: "bold", textAlign: "center", color: "white", fontSize: "12px" }}>
