                        ...
                        <CCard>
                            <CCardBody>
                                ...
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='bgcolor' style={{ backgroundColor: "", textAlign: "center", color: "white", fontSize: "17px" }}>PACKAGE DETAILS</th>
                                        </tr>
                                ...
                                <table className="table table-bordered mt-3">
                                    <tbody>
                                        <tr>
                                            <th colSpan={16} className='bgcolor' style={{ backgroundColor: "", textAlign: "center", color: "white", fontSize: "17px" }}>PACKAGE FEATURE LIST</th>
                                        </tr>
                                        <tr className='bgcolor1' style={{ fontWeight: "bold", textAlign: "center", color: "white" }}>
                                        ...
                                        {PackageFeatureList.map((FeatureList, index) => (
                                            <tr style={{ textAlign: "center", color: "black" }} key={index}>
                                                <td>{FeatureList.feature_heading}</td>
                                                <td>{FeatureList.feature_description}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
