...
const PackageList = (props) => {
    ...
    return (
        <>
            {
                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_PACKAGE_LIST) ?
                                                ...
                                                <table className="table table-bordered-less width100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>MRP</th>
                                                            {
                                                                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_EDIT_PACKAGE) ?
                                                                    <th>Edit</th>
                                                                    : null
                                                            }
                                                            {
                                                                cookies.allowed_features.includes(AppConstants.ALLOWED_FEATURE_DETAILS_PACKAGE) ?
                                                                    <th>Details</th>
                                                                    : null
                                                            }
                                                        </tr>
